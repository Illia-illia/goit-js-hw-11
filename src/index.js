// 1 cтворити функцію  для HTTP-запитів з використанням бібліотеки axios та синтаксису async/await.(окремо)
// 2 додати Notify, SimpleLightbox і стилі.
...
//   onRequestSerchFetch(request, page)
//     .then(({ data }) => {
//       hasImage = Math.ceil(data.totalHits / 40);
//       if (page > hasImage) {
